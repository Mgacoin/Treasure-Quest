...
public class Game {
    ...
    private void createNPC(){
        ...
        Lustucru = new NPC ("Lustucru", "I can not find the key in my pocket because I lost my glasses.", key, "old man");  
    }
    ...
    private void createRooms()
    {
        ...
        roomKey = newRoom ("roomKey","the room where is Lustucru who have the key of the jewels","Treasure quest/Images Zuul/lustucru_room.jpeg", Lustucru);
        ...
        room3.setExists (roomGhost, room2, null, null);
        store.setExists (null, null, null, room1);
        room2.setExists (room4, window1, room1, room3);
        window1.setExists (null, null, null, room2);
        roomGhost.setExists (lake1, null, null, null);
        room4.setExists (null, null, room2, null);
        lake1.setExists (castleDoor, null, lake2, null);
        lake2.setExists (lake1, null, null, null);
       castleDoor.setExists (roomJanitor, null, lake1, null);
       roomJanitor.setExists (null, null, castleDoor, room5);
       room5.setExists (roomKey, null, null, start);
       roomKey.setExists (roomTrap, room6, null, null);
       room6.setExits(null, null, room5, null);
        ...
        roomCave.setExitst(roomJewels, null, null, null);
        roomJewels.setExits(null, null, null, null);
       

        myPlayer.changeRoom(outside);  // start game outside
    }
